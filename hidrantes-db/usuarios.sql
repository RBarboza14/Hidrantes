...
DELIMITER //
CREATE PROCEDURE usuario_crear (in_cedula int, in_nombre varchar(30), in_apellido_1 varchar(30), in_apellido_2 varchar(30), in_telefono int, in_tipo int, in_contrasena varchar(30)) 
BEGIN
  INSERT INTO usuarios(cedula, nombre, apellido_1, apellido_2, telefono, tipo, contrasena)
  VALUES(in_cedula, in_nombre, in_apellido_1, in_apellido_2, in_telefono, in_tipo, in_contrasena);
END;
// DELIMITER ;
...
-- Bomberos
(111111111, 'Juan', 'Perez', 'Lopez', 11111111, 1, 'JuanPerez'),
(111111112, 'Carlos', 'Campos', 'Cerdas', 11111111, 1, 'CarlosCampos'),
(111111113, 'Pedro', 'Flores', 'Sanchez', 11111111, 1, 'PedroFlores'),
(111111114, 'Maria', 'Chaves', 'Zamora', 11111111, 1, 'MariaChaves'),
(111111115, 'Julieta', 'Gutierrez', 'Montero', 11111111, 1, 'JulietaGutierrez'),
-- Municipalidad
(111111116, 'Margarita', 'Lee', 'Torres', 11111111, 2, 'MargaritaLee'),
(111111117, 'Rosa', 'Baltodano', 'Cerdas', 11111111, 2, 'RosaBaltodano'),
(111111118, 'Julian', 'Torres', 'Nice', 11111111, 2, 'JulianTorres')
